...
const TO_EMAIL = "adriana@estudioghetti.com";
const FROM_EMAIL = "Estudio Ghetti <noreply@estudioghetti.com>";
const TIPO_LABELS = {
...
const POST = async ({ request }) => {
  const apiKey = "re_jMmae6V1_M3Y6SNBYr9VwmCqZ1MSc67mn";
  let payload;
  try {
