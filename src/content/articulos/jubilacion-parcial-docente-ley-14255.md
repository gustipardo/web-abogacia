---
title: "Jubilación parcial Ley 14.255: jubilar un cargo y seguir el otro"
description: "Cómo funciona la jubilación parcial docente bajo la Ley 14.255: jubilar un cargo cumpliendo los requisitos y continuar trabajando en otro durante la transición al retiro."
...
faqs:
  - question: "¿Necesito cumplir los requisitos generales para jubilar el primer cargo?"
    answer: "Sí. Para jubilar uno de los cargos hay que cumplir los requisitos del régimen aplicable — edad y antigüedad — sobre ese cargo. La jubilación parcial no salta los requisitos generales, solo permite que el otro cargo siga activo."
  - question: "¿El haber del cargo jubilado se actualiza después?"
    answer: "Sí. El haber del cargo ya jubilado sigue siendo móvil y se actualiza con las paritarias docentes en la misma proporción que el de los activos."
  - question: "¿Cuándo conviene esta opción?"
    answer: "Cuando hay diferencia importante entre los cargos y se quiere asegurar el primero sin renunciar a los ingresos del segundo. También como puente para una transición gradual al cese definitivo."
---
